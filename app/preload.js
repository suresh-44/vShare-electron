...
/* harmony import */ var jsonfile__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jsonfile__WEBPACK_IMPORTED_MODULE_1__);
...
const appData = {
  write: (key, value) => {
    try {
      fs__WEBPACK_IMPORTED_MODULE_0___default.a.accessSync(appDataFile, fs__WEBPACK_IMPORTED_MODULE_0___default.a.constants.F_OK);
      let json = jsonfile__WEBPACK_IMPORTED_MODULE_1___default.a.readFileSync(appDataFile);
      json[key] = value;
      return jsonfile__WEBPACK_IMPORTED_MODULE_1___default.a.writeFile(appDataFile, json);
    } catch (e) {
      let obj = {};
      obj[key] = value;
      return jsonfile__WEBPACK_IMPORTED_MODULE_1___default.a.writeFile(appDataFile, obj);
    }
  },
  get: key => {
    let json = jsonfile__WEBPACK_IMPORTED_MODULE_1___default.a.readFileSync(appDataFile);
...
/* harmony default export */ __webpack_exports__["default"] = (appData);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app-data */ "./src/helpers/app-data.js");

const firstRun = {
  appDataKey: "first-run",
  firstRunDone: () => {
    _app_data__WEBPACK_IMPORTED_MODULE_0__["default"].write(undefined.appDataKey, 'shown');
  },
  isFirstRun: () => {
    return !_app_data__WEBPACK_IMPORTED_MODULE_0__["default"].exists(undefined.appDataKey);
  }
};
/* harmony default export */ __webpack_exports__["default"] = (firstRun);
...
/* harmony import */ var _helpers_first_run__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers/first-run */ "./src/helpers/first-run.js");
/* harmony import */ var _secure__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./secure */ "./src/secure/index.js");
...
const currentWindow = electron__WEBPACK_IMPORTED_MODULE_3__["remote"].getCurrentWindow();
console.log("starting preload.js");

const firstCheck = () => {
  console.log("Checking if app is running for first time");

  if (_helpers_first_run__WEBPACK_IMPORTED_MODULE_4__["default"].isFirstRun()) {
    console.log("......App is running for first time");
    currentWindow.loadURL(url__WEBPACK_IMPORTED_MODULE_6___default.a.format({
      pathname: path__WEBPACK_IMPORTED_MODULE_7___default.a.join(__dirname, "intro.html"),
      protocol: "file:",
      slashes: true
    }));
  }
...
electron__WEBPACK_IMPORTED_MODULE_0__["session"].defaultSession.webRequest.onHeadersReceived((details, callback) => {
  callback({
    responseHeaders: `default-src 'none'`
  });
});
